...
plt.boxplot(data['capital-gain'])
plt.title('Box Plot of Capital Gain')  # Add a title
plt.ylabel('Capital Gain')  # Label the y-axis
plt.xticks([1], ['Capital Gain'])  # Set x-tick labels
plt.show()
...
import time
import requests  # For checking if Streamlit is ready
...
try:
    ...
    print('This tunnel will close when you stop this Python process')
